...
public class DynamoDBReflector {
     ...
     */
    public <T> ArgumentUnmarshaller getArgumentUnmarshaller(final T toReturn, final Method getter, final Method setter) {
    ...
    /**
     * 
     * Returns the attributeName for the given class fieldName. Returns null of not found in the class.
     */
    ...
    /**
     * 
     * Determine whether the given getter is a (S, N, SS, NS).
